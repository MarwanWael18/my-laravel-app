...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex items-center lg:justify-center min-h-screen flex-col">
        <header class="w-full text-sm mb-6 not-has-[nav]:hidden" style="position: absolute; z-index: 1; top: 0; backdrop-filter: blur(23px)">
            @if (Route::has('login'))

                <nav class="navbar navbar-expand-sm navbar-light bg-transparent p-3">
                    <div class="container">
                        <a class="navbar-brand text-white" style="font-weight: 900" href="#"><span class="border-warning rounded-3 p-1 mx-1 text-black" style="background-color: #F58C26; box-shadow: 0px 0px 10px #F58C26;">NX</span>NEXUS</a>
                        <button
                        ...
                        <div class="collapse navbar-collapse" id="collapsibleNavId">
                            <ul class="navbar-nav m-auto mt-2 mt-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link" style="color:<?php if ($active == "home") {
                                        echo '#F58C26';
                                    }else{ echo 'white';}?>" href="{{ route('welcome') }}" aria-current="page"
                                        >Home
                                        <span class="visually-hidden">(current)</span></a
                                    >
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link mx-3" style="color:<?php if ($active == 'store') {
                                        echo '#F58C26';
                                    }else{ echo 'white';}?>" href="{{ route('shop') }}">Shop</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link mx-3" style="color: <?php if ($active == 'about') {
                                        echo '#F58C26';
                                    }else{ echo 'white';}?>" href="about">About</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" style="color:<?php if ($active == 'contact') {
                                        echo '#F58C26';
                                    }else{ echo 'white';}?>" href="contact">Contact</a>
                                </li>
                        ...
                        <ul class="d-flex align-items-center">
                            <li>
                                <a href="{{ route('shop') }}" class="btn rounded-4 px-3 py-1" style="font-weight: 500; box-shadow: 0px 0px 10px #F58C26; background-color:#F58C26; border:1px solid #F58C26;">
                                    Shop Now
                                </a>
                            </li>
                            <li class="dropdown mx-4">
                                        <a
                                            ...
                                            aria-haspopup="true"
                                            aria-expanded="false"
                                            ><i class="fa-solid fa-circle-user" style="color: #ffffff; font-size: 25px"></i></a
                                        >
                                        <div
                        ...
                        @endauth
                                        ...
                                        <li>
                                            <a
                                                class="nav-link"
                                                href="{{ route('cart') }}"
                                                ><i class="fa-solid fa-cart-shopping" style="color: #ffffff; font-size: 25px"></i></a
                                            >
                                        </li>
        ...
        <div class="flex flex-column items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0 vh-100" style="border-bottom: 1px solid rgba(154, 154, 154, 0.28)" id='header'>
            <h1 class="text-white text-center" style="font-size: 65px; font-weight: 600">Experience <br> Technology <span style="color: #F58C26; text-shadow: 1px 2px 4px #F58C26; ">Like <br> Never Before</span></h1>
            <p class="text-center my-3" style="color: rgb(118, 118, 118)">High-performance computers, monitors, keyboards, and <br> graphic cards - engineered for the future</p>
            <div class="flex gap-3">
                <a href="{{ route('shop') }}" class="btn px-3 py-2 rounded-5" style="background-color: #F58C26;box-shadow: 0px 0px 10px #F58C26;">Shop Now <i class="fa-solid fa-arrow-right "></i></a>
                <a href="about" class="btn bg-transparent px-3 py-2 text-white rounded-5"  id="button" style="font-weight: 500">Learn More</a>
            </div>
        </div> {{-- main --}}

        <div class="container-fluid" style="border-bottom: 1px solid rgba(154, 154, 154, 0.28);">
            <div class="row text-white p-4 align-items-center">
                <div class="col-4 d-flex justify-content-center">
                    <p>
                        <i class="fas fa-bolt p-3 rounded-4" style="font-size: 25px; background-color: #26190E;color: #F58C26;"></i>
                    </p>
                        <div class="mx-3">
                            <p>
                                Lightning Fast
                            </p>
                            <p style="font-size: 12px; color: rgb(118, 118, 118);">
                                Next-gen performance for demanding workflows
                            </p>
                        </div>
                </div>
                <div class="col-4 d-flex align-items-center">
                    <p>
                        <i class="fas fa-shield p-3 rounded-4" style="font-size: 25px; background-color: #26190E; color: #F58C26;"></i>
                    </p>
                        <div class="mx-3">
                            <p>
                                3 Year Warranty
                            ...
                            <p style="font-size: 12px; color: rgb(118, 118, 118);">
                                Premium protection on every product
                            </p>
                        </div>
                </div>
                <div class="col-4 d-flex align-items-center">
                    <p class="">
                        <i class="fas fa-truck p-3 rounded-4" style="font-size: 25px; background-color: #26190E;color: #F58C26;"></i>
                    </p>
                        <div class="mx-3">
                            <p>
                                Free Shipping
                            ...
                            <p style="font-size: 12px; color: rgb(118, 118, 118);">
                                Complimentary delivery on orders ove $500
                            </p>
                        </div>
                </div>
        ...
        <div class="products p-5" style="border-bottom: 1px solid rgba(154, 154, 154, 0.28); width:100%">
            <div class="text-center text-white">
                <p style="color: #F58C26">FEATURED</p>
                <p style="font-size: 47px; font-weight: 500;" class="mb-2">Premium Products</p>
                <p style="color: rgb(118, 118, 118)">Handpicked selection of our finest hardware, built <br> for professionals and enthusiasts</p>
            </div>

            <div class="container mt-5">
                <div class="row">

                    @foreach (collect($store)->slice(0,4) as $product)
                    <div class="col-3">
                        <div class="card rounded-4" style="background-color: #181614" id="products">
                            <img class="card-img-top rounded-top-4" src="{{ asset('storage/' . $product->image) }}" alt="Title"/>
                            <div class="card-body">
                                <h4 class="card-title text-white">{{ $product->name }}</h4>
                                <p class="card-text text-truncate" style="color: rgb(118, 118, 118)">{{ $product->description }}</p>

                                <div class="d-flex justify-content-between align-items-center mt-4">
                                    <p style="font-weight: 800" class="text-white">${{ $product->price }}</p>
                                    <button type="button" class="btn px-2 py-2 rounded-5 add-cart" data-id="{{ $product->id }}" style="background-color: #F58C26; font-weight:500; border: none;"><i class="fa-solid fa-cart-shopping"></i> Add</button>

<span class="text-success msg-{{ $product->id }}" style="display:none; font-size: 12px;"> Added!</span>
            ...
            <a href="#" class="d-flex justify-content-center align-items-center mt-5" style="color: #F58C26">Show more <i class="fa-solid fa-arrow-right  mx-2"></i></a>


        </div> {{-- premium products --}}

        <div class="upgrade text-center mt-5" style="border-bottom: 1px solid rgba(154, 154, 154, 0.28); width:100%">
            <h2 class="text-white mb-3" style="font-size: 42px; font-weight: 500;">Ready To Upgrade?</h2>
            <p style="color:  rgb(118, 118, 118)">Join thousands of professionals who trust NEXUS for their premium <br> tech needs. Free shipping on all orders over $500.</p>
            <a href="{{ route('shop') }}" class="btn rounded-5 mt-3 mb-5" style="background-color: #F58C26; font-weight:500">Start Shopping <i class="fa-solid fa-arrow-right "></i></a>
        </div>{{-- upgrade --}}

        <footer class="footer">
            <p class="text-center p-5 text-white">&copy;2026 NEXUS. All right reserved.</p>
        </footer>
...
$(document).on('click', '.add-cart', function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            setTimeout(() => {
                button.css('background-color', '#F58C26');
            }, 2000);
        }
    });
});
